...
class PostController extends Controller
{
    ...
    // Menampilkan daftar berita untuk publik (root.pages.news-index)
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            // Menyimpan nama file gambar ke database (dengan prefix images/ agar sesuai dengan lokasi fisik dan URL asset)
            $post->image = "images/news/" . $name;
        }
        ...
        // Redirect ke halaman index berita publik agar user langsung melihat postingan baru
        return redirect()->route('root.news-index');
    }
