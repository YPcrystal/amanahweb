...
use App\Http\Controllers\Admin\Pages\Finance\StudentScholarshipController;
...
Route::group([
    ...
    Route::middleware(['is-active:1'])->group(function () {
        ...
        Route::prefix('finance')->name('finance.')->group(function () {
            ...
            // Scholarship
            Route::prefix('data-beasiswa')->name('scholarship-')->group(function () {
            ...
            Route::prefix('data-pembayaran')->name('pembayaran-')->group(function () {
                ...
                Route::patch('/unpaid-mahasantri/{code}/{userId}/mark-paid', [PembayaranController::class, 'markAsPaid'])->name('unpaid-mahasantri-mark-paid');
                Route::patch('/unpaid-mahasantri/{code}/{userId}/mark-unpaid', [PembayaranController::class, 'markAsUnpaid'])->name('unpaid-mahasantri-mark-unpaid');
            });
