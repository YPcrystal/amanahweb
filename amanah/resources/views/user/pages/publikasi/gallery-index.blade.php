            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                @foreach ($album as $item)
                    <div class="relative group">
                        ...
                        <form action="{{ route($prefix . 'publish.album-destroy', $item->slug) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus album ini?');" class="absolute top-2 right-2">
                            @csrf
                            @method('DELETE')
