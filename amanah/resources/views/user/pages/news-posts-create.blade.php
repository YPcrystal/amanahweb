...
@endsection
@section('custom-css')
    <!-- Tambahkan CSS khusus untuk textarea -->
    <style>
        .editor-container {
            margin-top: 1rem;
        }
                        ...
                        <div class="md:col-span-4">
                            <div class="space-y-4">
                                <div class="aspect-w-16 aspect-h-9 bg-gray-100 light:bg-gray-700 rounded-lg overflow-hidden">
                                    <div class="flex items-center justify-center w-full h-full min-h-[180px] bg-gray-100 light:bg-gray-700">
                                        <img id="image-preview" src="{{ asset('images/default-post.jpg') }}" class="max-h-48 w-auto object-contain mx-auto" alt="Post Cover Preview">
                                    </div>
                                </div>
