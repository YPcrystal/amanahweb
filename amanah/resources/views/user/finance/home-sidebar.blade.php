<div class="sidebar-menu">
    ...
    <li class="list-none sidebar-item has-sub {{ Route::is($prefix . 'finance.*') ? 'active' : '' }}">
        ...
        <ul id="dropdown-finance"
            class="submenu pl-12 mt-1 space-y-1 {{ Route::is($prefix . 'finance.*') ? '' : 'hidden' }}">
            <li
                class="submenu-item {{ Route::is($prefix . 'finance.tagihan-*') ? 'bg-green-50 text-green-700 font-semibold rounded-md' : '' }}">
            ...
            <li
                class="submenu-item {{ Route::is($prefix . 'finance.pembayaran-*') ? 'bg-green-50 text-green-700 font-semibold rounded-md' : '' }}">
                <a href="{{ route($prefix . 'finance.pembayaran-index') }}"
                    class="block py-2 pl-3 pr-4 text-sm rounded-md hover:bg-green-100 hover:text-green-700 transition-colors duration-200">Data
                    Pembayaran</a>
            </li>
            <li
                class="submenu-item {{ Route::is($prefix . 'finance.unpaid-mahasantri') ? 'bg-green-50 text-green-700 font-semibold rounded-md' : '' }}">
            ...
            <li
                class="submenu-item {{ Route::is($prefix . 'finance.keuangan-*') ? 'bg-green-50 text-green-700 font-semibold rounded-md' : '' }}">
                <a href="{{ route($prefix . 'finance.keuangan-index') }}"
                    class="block py-2 pl-3 pr-4 text-sm rounded-md hover:bg-green-100 hover:text-green-700 transition-colors duration-200">Data
                    Keuangan</a>
            </li>
            <li
                class="submenu-item {{ Route::is($prefix . 'finance.scholarship-*') ? 'bg-green-50 text-green-700 font-semibold rounded-md' : '' }}">
    ...
    <li class="list-none sidebar-item has-sub {{ Route::is('web-admin.approval.*') ? 'active' : '' }}">
        ...
        <ul id="dropdown-approval"
            class="submenu pl-12 mt-1 space-y-1 {{ Route::is('web-admin.approval.*') ? '' : 'hidden' }}">
            <li
                class="submenu-item {{ Route::is($prefix . 'approval.absen-*') ? 'bg-green-50 text-green-700 font-semibold rounded-md' : '' }}">
